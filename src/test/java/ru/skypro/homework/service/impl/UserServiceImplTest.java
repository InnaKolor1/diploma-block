...
class UserServiceImplTest {
    ...
    void getCurrentUser_ShouldReturnUser_WhenUserExists() {
        String username = "osy@_bender@example.com";
        UserEntity userEntity = new UserEntity();
        userEntity.setEmail(username);
        userEntity.setFirstName("Osya");

        User expectedUser = new User(1, username, "Osya", "Bender", "79001112244", "image.jpg");
    ...
    void updateUser_ShouldUpdateAndReturnUser() {
        ...
        User expectedUser = new User(12, username, "Kisa", "Vorobiyaninov", "79001112233", "image.jpg");
        expectedUser.setEmail(username);
